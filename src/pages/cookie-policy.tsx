...
export default function CookiePolicy() {
  return (
    <>
      <Head>
        <title> Cookie Policy | ESAN</title>
      </Head>
      ...
      <Container>
        ...
        <Box sx={{ pb: 8 }}>
          <Typography variant="body1" color="text.secondary" sx={{ pt: 2 }}>
            ESAN uses cookies, mobile identifiers, tracking URLs, log data and similar technologies
            to help provide, protect, and improve the ESAN Platform. This Cookie Policy (“Policy”)
            supplements the ESAN Privacy Policy and explains how and why we use these technologies
            and the choices you have.
            <Typography variant="h6" sx={{ pt: 3 }} color="textPrimary">
              Cookies{' '}
            </Typography>
            <Typography>
              When you visit the ESAN Platform we may place cookies on your device. Cookies are
              ...
              partners may also use these tracking technologies on the ESAN Platform or engage
              others to track your behavior on our behalf.
              <br />
              <br />
              There are two types of cookies used on the ESAN Platform: (1) “session cookies” and
              ...
              be used again the next time you access the ESAN Platform.
              <br />
              <br />
              ...
              features, availability, and functionality of the ESAN Platform.
            </Typography>
            <Typography variant="h6" sx={{ pt: 3 }} color="textPrimary">
              Flash Cookies
            </Typography>
            ...
            <Typography>
              ...
              the ESAN Platform, your operating system type, browser type, domain, and other system
              settings, as well as the language your system uses and the country and time zone where
              your device is located. Our server logs also record the IP address of the device you
              use to connect to the Internet. An IP address is a unique identifier that devices
              require to identify and communicate with each other on the Internet. We may also
              collect information about the website you were visiting before you came to the ESAN
              Platform and the website you visit after you leave the ESAN Platform.
              <br />
              <br />
              We may also collect information about your use of the ESAN Platform such as when we
            ...
            <Typography>
              ESAN permits third parties to collect the information described above through our
              ...
              ESAN Platform. These technologies (1) help us analyze how you use the ESAN Platform,
              such as by noting the third party services from which you arrived, (2) market and
              advertise ESAN services to you on the ESAN Platform and third party websites, (3) help
              us detect or prevent fraud or conduct risk assessments, and (4) collect information
              about your activities on the ESAN Platform, other sites, and/or the ads you have
              clicked on. For example, to help us better understand how people use the ESAN
              Platform, we work with a number of analytics partners, including Google Analytics. To
              prevent Google Analytics from using your information for analytics, you may install
              the Google Analytics Opt-Out Browser by clicking here. In some cases, cookies are
              placed if certain criteria is met, such as being logged into the third party service
              on the same browser.
              <br />
              <br />
              The ESAN Platform may use social plugins provided and operated by third parties, such
              as Facebook’s Like Button. As a result of this, you may send to the third party the
              information that you are viewing on a certain part of the ESAN Platform. If you are
              not logged into your account with the third party, then the third party may not know
              your identity. If you are logged in to your account with the third party, then the
              third party may be able to link information or actions about your interactions with
              the ESAN Platform to your account with them. Please refer to the third party’s privacy
            ...
            <Typography>
              ...
              disable cookies through your browser settings, the ESAN Platform currently does not
              ...
              to decline cookies, some parts of the ESAN Platform may not work as intended or may
              not work at all.
            </Typography>
          </Typography>
        </Box>
