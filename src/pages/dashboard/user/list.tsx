...
// sections
import { UserTableToolbar, UserTableRow } from '../../../sections/@dashboard/userlist/list';
...
const ROLE_OPTIONS = ['Admin', 'Player', 'Organizer', 'Blog Writer', 'Organization'];
...
export default function UserListPage() {
  ...
  const [tableData, setTableData] = useState<IUserAccountList[]>([]);
  ...
  const getAllUsers = useCallback(async () => {
    try {
      const response = await axiosInstance2.get('/get-user-lists');
